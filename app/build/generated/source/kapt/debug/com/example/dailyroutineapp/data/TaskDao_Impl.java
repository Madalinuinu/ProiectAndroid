...
public final class TaskDao_Impl implements TaskDao {
  ...
  private final SharedSQLiteStatement __preparedStmtOfUpdateTaskFields;
  ...
  public TaskDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTask = new EntityInsertionAdapter<Task>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `tasks` (`id`,`title`,`description`,`color`,`userEmail`) VALUES (nullif(?, 0),?,?,?,?)";
      }
    ...
    this.__updateAdapterOfTask = new EntityDeletionOrUpdateAdapter<Task>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `tasks` SET `id` = ?,`title` = ?,`description` = ?,`color` = ?,`userEmail` = ? WHERE `id` = ?";
      }
    ...
    this.__preparedStmtOfUpdateTaskFields = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "UPDATE tasks SET title = ?, description = ? WHERE id = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object deleteById(final int taskId, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
  ...
  @Override
  public Object updateTaskFields(final int taskId, final String title, final String description,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfUpdateTaskFields.acquire();
        int _argIndex = 1;
        if (title == null) {
        ...
        try {
          ...
          __preparedStmtOfUpdateTaskFields.release(_stmt);
        }
      }
    }, $completion);
  }
      ...
      public List<Task> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Task(_tmpId,_tmpTitle,_tmpDescription,_tmpColor,_tmpUserEmail);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public Task call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new Task(_tmpId,_tmpTitle,_tmpDescription,_tmpColor,_tmpUserEmail);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Flow<List<Task>> getTasksForUser(final String email) {
    final String _sql = "SELECT * FROM tasks WHERE userEmail = ? ORDER BY id ASC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (email == null) {
